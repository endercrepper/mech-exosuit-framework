...
def build_section_12(story, ctx):
    ...
    rows = [
        ...
        ['Persona AI Subcore (ModName_SubcorePersonaAI)', '[Mod Name]',
         'Nuovo ThingDef custom della mod. Tier 3 del sistema subcore: +8 skill (cap effettivo mod = 18, sotto cap vanilla 20), 250 HP, +2 BW, +25% battery rispetto al Standard. Craftato a partire da un Persona Core vanilla.'],
        ['Bandwidth', 'vanilla',
